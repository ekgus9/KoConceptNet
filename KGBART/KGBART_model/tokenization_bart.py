...
class BartTokenizer(RobertaTokenizer):
    ...
    max_model_input_sizes = {m: 1026 for m in _all_bart_models}
...
class BartTokenizerFast(RobertaTokenizerFast):
    # merges and vocab same as Roberta
    max_model_input_sizes = {m: 768 for m in _all_bart_models} #1024
    pretrained_vocab_files_map = {
        "vocab_file": {m: vocab_url for m in _all_bart_models},
        "merges_file": {m: merges_url for m in _all_bart_models},
    }
...
class MBartTokenizer(XLMRobertaTokenizer):
    ...
    max_model_input_sizes = {m: 768 for m in _all_mbart_models} #1024
